...
public class DivOp extends FormatBaseAST implements EmittableFormatASTNode {
    public DivOp() {
        type = Type.DIVOP;
    }
    ...
    public CalcStackEntry emit(boolean invert) {
        return emitSingleCodeEntry(CalcStackOpcode.CalcStackDivide, super.emit(invert));
    }
}
