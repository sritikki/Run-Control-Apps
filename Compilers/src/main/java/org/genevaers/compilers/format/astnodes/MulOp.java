...
public class MulOp extends FormatBaseAST implements EmittableFormatASTNode {
    public MulOp() {
        type = Type.MULOP;
    }
    ...
    public CalcStackEntry emit(boolean invert) {
        return emitSingleCodeEntry(CalcStackOpcode.CalcStackMultiply, super.emit(invert));
    }
