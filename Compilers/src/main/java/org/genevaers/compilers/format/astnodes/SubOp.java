...
public class SubOp extends FormatBaseAST implements EmittableFormatASTNode {
    public SubOp() {
        type = Type.SUBOP;
    }
    ...
    public CalcStackEntry emit(boolean invert) {
        return emitSingleCodeEntry(CalcStackOpcode.CalcStackSubtract, super.emit(invert));
    }
}
