...
public class SFLPEmitter extends StringComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableF2 cflp = (LogicTableF2) ltFact.getSFLP(((LookupFieldRefAST) lhs).getRef(), ((FieldReferenceAST)rhs).getRef());
        LogicTableArg arg = cflp.getArg1();
