...
public class CFAEEmitter extends ComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableNameF1 cfae = (LogicTableNameF1) ltFact.getCFAE(calcNode.getAccName(), ((FieldReferenceAST) rhs).getRef(), op);
        return cfae;
    }
