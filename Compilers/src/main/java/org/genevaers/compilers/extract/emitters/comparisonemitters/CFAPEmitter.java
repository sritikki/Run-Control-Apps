...
public class CFAPEmitter extends ComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableNameF1 cfap = (LogicTableNameF1) ltFact.getCFAP(calcNode.getAccName(), ((FieldReferenceAST) rhs).getRef(), op);
        return cfap;
    }
