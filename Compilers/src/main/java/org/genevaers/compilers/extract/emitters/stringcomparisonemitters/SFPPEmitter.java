...
public class SFPPEmitter extends StringComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableF2 cfpp = (LogicTableF2) ltFact.getSFPP(((FieldReferenceAST) lhs).getRef(), ((FieldReferenceAST)rhs).getRef());
        return cfpp;
    }
