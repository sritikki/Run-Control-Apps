...
public class SFEPEmitter extends StringComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableF2 cfep = (LogicTableF2) ltFact.getSFEP(((FieldReferenceAST) lhs).getRef(), ((FieldReferenceAST)rhs).getRef());
        return cfep;
    }
