...
public class CFPEEmitter extends ComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableF2 cfpe = (LogicTableF2) ltFact.getCFPE(((FieldReferenceAST) lhs).getRef(), ((FieldReferenceAST)rhs).getRef(), op);
        return cfpe;
    }
