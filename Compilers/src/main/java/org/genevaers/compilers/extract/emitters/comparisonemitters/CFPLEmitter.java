...
public class CFPLEmitter extends ComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableF2 cfpl = (LogicTableF2) ltFact.getCFPL(((FieldReferenceAST) lhs).getRef(), ((LookupFieldRefAST)rhs).getRef(), op);
