...
public class CFCAEmitter extends ComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableNameValue cfca = (LogicTableNameValue) ltFact.getCFCA(calcNode.getAccName(), ((GenevaERSValue)lhs).getValueString(), op);
        return cfca;
    }
