...
public class CFLPEmitter extends ComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableF2 cflp = (LogicTableF2) ltFact.getCFLP(((LookupFieldRefAST) lhs).getRef(), ((FieldReferenceAST)rhs).getRef(), op);
