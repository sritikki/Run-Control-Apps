...
public class SFPEEmitter extends StringComparisonEmitter{
    ...
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        ...
        LogicTableF2 cfpe = (LogicTableF2) ltFact.getSFPE(((FieldReferenceAST) lhs).getRef(), ((FieldReferenceAST)rhs).getRef());
        return cfpe;
    }
