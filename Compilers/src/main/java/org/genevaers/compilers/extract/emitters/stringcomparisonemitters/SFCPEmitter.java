...
public class SFCPEmitter extends StringComparisonEmitter{

    @Override
    public LTFileObject getLTEntry(String op, ExtractBaseAST lhs, ExtractBaseAST rhs) {
        LtFuncCodeFactory ltFact = LtFactoryHolder.getLtFunctionCodeFactory();
        LogicTableF1 cfce = (LogicTableF1) ltFact.getSFCP(((GenevaERSValue)lhs).getValueString(), ((FieldReferenceAST) rhs).getRef());
