...
public class SpecGenerator {
    ...
    private static final String DEVSPECFILELIST = "devspecfilelist.yaml";
    ...
    private void showMenu() {
        ...
        menu.append(YELLOW+"Current SpecFileList: "+RESET + fmEnv.get("SPECFILELIST")+"\n");
    ...
    private void saveSpecList() {
        try {
             mapper.writeValue(new File(DEVSPECFILELIST), specFiles);
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    private void getDevSpecFileList() {
        yr = new YAMLReader();
        try {
            specFiles = yr.readSpecFileList(new File(DEVSPECFILELIST));
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
