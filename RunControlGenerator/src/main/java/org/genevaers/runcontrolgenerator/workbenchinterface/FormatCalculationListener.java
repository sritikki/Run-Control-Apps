...
import org.genevaers.grammar.FormatCalculationBaseListener;
import org.genevaers.grammar.FormatCalculationParser;

public class FormatCalculationListener extends FormatCalculationBaseListener{
	private Set<Integer> columnRefs = new TreeSet<>();

   	@Override 
    public void exitColumnRef(FormatCalculationParser.ColumnRefContext ctx) { 
