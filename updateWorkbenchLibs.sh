...
# cp GenevaIO/target/genevaio-1.0.2.jar ../Workbench/plugins/genevagui/lib/
# cp Repository/target/repository-1.0.2.jar ../Workbench/plugins/genevagui/lib/
# cp Utilities/target/utilities-1.0.2.jar ../Workbench/plugins/genevagui/lib/