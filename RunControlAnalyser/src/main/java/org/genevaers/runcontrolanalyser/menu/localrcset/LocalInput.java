...
public class LocalInput extends MenuItem implements MenuSetting {

    LocalInput() {
        color = Color.MAGENTA;
        header = "Local Options";
        prompt = "Base directory for rc sets";
        comment = "relative path - defaults to cwd";
    }
    ...
    public void setValue(String v) {
        RCAGenerationData.setLocalRC(v);
    }

    @Override
    public String getValue() {
        return RCAGenerationData.getLocalRC();
    }
