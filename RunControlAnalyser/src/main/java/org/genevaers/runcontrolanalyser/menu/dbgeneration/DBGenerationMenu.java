...
public class DBGenerationMenu extends Menu {

    public DBGenerationMenu() {
        menuItems.add(new GenDBServer());
        menuItems.add(new GenDBName());
        menuItems.add(new GenDBPort());
        menuItems.add(new GenDBSchema());
        menuItems.add(new GenEnvironmentItem());
        menuItems.add(new GenDBViews());
        menuItems.add(new RCSetName());
        menuItems.add(new GenDBRun());
        menuItems.add(new DBReturn());
    }
