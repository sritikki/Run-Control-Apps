...
public class FTPServer extends MenuItem implements MenuSetting {

    FTPServer() {
        color = Color.MAGENTA;
        header = "Set FTP Options";
        prompt = "Server";
        comment = "";
    }
    ...
    public void setValue(String v) {
        RCAGenerationData.setDbServer(v);
    }

    @Override
    public String getValue() {
        return RCAGenerationData.getDbServer();
    }
